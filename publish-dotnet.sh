...
scp -i ~/ecs-demo.pem hwapp.tar ec2-user@ec2-54-254-249-64.ap-southeast-1.compute.amazonaws.com:hwapp.tar

#untar the binaries on the test server
ssh -i ~/ecs-demo.pem ec2-user@ec2-54-254-249-64.ap-southeast-1.compute.amazonaws.com "tar -xf hwapp.tar"
